...
async def startup_event():
    # Keep the complete schema synchronized on every runtime (SQLite or PostgreSQL).
    # The bootstrap is idempotent and performs only CREATE IF NOT EXISTS / ADD COLUMN.
